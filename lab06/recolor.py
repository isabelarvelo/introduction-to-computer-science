...
class Recolor(object):
    ...
    def after(self,x,y):
        ...
        result = Color(self._clust.classify((r,g,b)))
        return result
...
if __name__ == "__main__":
    ...
    #Extra Credit: print k labels to the output
    print ("The rgb values for k labels are {}.".format(result._clust._label))
